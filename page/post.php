...
<html lang="en">
  ...
  <body>
    ...
    <!-- Page Header -->
    <header class="masthead" style="background-image: url('img/TulumKiss.jpg')">
      <div class="overlay"></div>
      <div class="container">
        <div class="row">
          <div class="col-lg-8 col-md-10 mx-auto">
            <div class="post-heading">
              <h1>Here in this page we can post eachother anything</h1>
              <h2 class="subheading">what we post here can be read only by us, so dont worry to post 
                whatever you like :)
              </h2>
            </div>
          </div>
      ...
      <div class="row">
        ...
        <form action="postScript.php" method="post" >
          <div class="form-group">
            <label for="postBody">Say something:</label>
            <textarea class="form-control rounded-0" id="postBody" name="body" rows="10"></textarea>
          </div>
